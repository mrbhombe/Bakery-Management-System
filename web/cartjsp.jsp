<%-- 
    Document   : cartjsp
    Created on : 23 Apr, 2020, 4:03:35 PM
    Author     : Mohan
--%>
...
<body>
                                    ...
                                    %>
                                        ...
                                        <td class="qty">
                                            <div class="qty-btn d-flex" style="padding:5px">
                                                ...
                                                <span style="padding:15px"><%=resultSet.getString("pqty") %></span>
     ...
     <div class="cart-btn mt-100">
          <% if (i==1)
                                    ...
                                    %>
                                <form action="orderjsp.jsp">
								<input type="submit" name="submit" value="Checkout" style="padding:10px; background:#FFCC00;color:#FFFFFF;border:none">
								</form><% } %>
                            </div>                
                </div>
            </div>
...
function myfun(pid)
{
  location.replace("deleteProduct?pid="+pid);
}
</script>
</body>
